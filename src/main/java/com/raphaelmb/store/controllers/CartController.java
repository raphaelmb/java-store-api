...
import com.raphaelmb.store.dtos.AddItemToCartRequest;
import com.raphaelmb.store.dtos.CartDto;
import com.raphaelmb.store.dtos.CartItemDto;
import com.raphaelmb.store.dtos.UpdateCartItemRequest;
...
public class CartController {
    ...
    public ResponseEntity<?> updateItem(
        ...
        var cartItem = cart.getItems().stream()
                ...
                .findFirst()
                .orElse(null);
        if (cartItem == null) return ResponseEntity.status(HttpStatus.NOT_FOUND).body(Map.of("error", "Product not found in the cart"));
